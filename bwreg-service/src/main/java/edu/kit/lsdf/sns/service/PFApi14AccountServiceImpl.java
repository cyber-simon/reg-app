...
@Stateless
public class PFApi14AccountServiceImpl implements PFApi14AccountService {
	...
	public PFAccount findById(String id, ServiceEntity serviceEntity) throws RegisterException {
		...
		PFApi14Worker pfWorker = new PFApi14Worker(PropertyReader.newRegisterPropReader(serviceEntity), null);
