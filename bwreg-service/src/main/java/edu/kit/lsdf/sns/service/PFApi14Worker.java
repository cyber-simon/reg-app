...
public class PFApi14Worker {

	private static final Logger logger = LoggerFactory.getLogger(PFApi14Worker.class);
	...
	public PFApi14Worker(PropertyReader prop) throws RegisterException {
		this(prop, null);
	}
	
	public PFApi14Worker(PropertyReader prop, Auditor auditor) throws RegisterException {
