...
public class OidcAttributeReleaseBean implements Serializable {
	...
	public void preRenderView(ComponentSystemEvent ev) {
		if (identity == null) {
			...
			flowState = flowStateService.findByIdWithAttrs(session.getOidcFlowStateId(), OidcFlowStateEntity_.clientConfiguration);
			if (flowState == null) {
	...
	public void accept() {
		...
		attributeRelease = attributeReleaseService.save(attributeRelease);
		...
		flowState = flowStateService.save(flowState);
