...
public class ViewIds {
	...
	public static final String EDIT_EMAIL_SIGNATURE = "/admin/mail/edit-email-signature.xhtml";
	public static final String EDIT_EMAIL_TEMPLATE = "/admin/mail/edit-email-template.xhtml";

	public static final String DELETE_EMAIL_SIGNATURE = "/admin/mail/delete-email-signature.xhtml";
	...
	public static final String SHOW_EMAIL_OVERVIEW = "/admin/mail/show-email-overview.xhtml";
